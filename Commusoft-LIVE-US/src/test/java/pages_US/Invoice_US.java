...
public class Invoice_US extends Wrapper_US{
	...
	public Invoice_US(WebDriver ldriver)
	{
	 ...
	 public void InvoiceTab() throws InterruptedException
	    ...
	    {
	        click("(//a[@href='javascript: void(0)'])[2]");
	    }
	    ...
	    {
	        selectdropdownvalue("//select[@formcontrolname='invoiceCategoryId']", "13");
	    }
	    public void editinvoice_Category()
	    {
	        selectdropdownvalue("//select[@formcontrolname='invoiceCategoryId']", "12");
	    }
