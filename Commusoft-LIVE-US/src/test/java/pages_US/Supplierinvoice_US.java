...
public class Supplierinvoice_US extends Wrapper_US {
//
...
//	@FindBy(xpath="//span [@class = 'control-error-message ng-scope']") WebElement confirmationMessage;
	...
	public Supplierinvoice_US(WebDriver ldriver)
	{
		this.driver = ldriver;
	}
...
public void vat(String b) throws InterruptedException
{
	...
	Thread.sleep(1000);
	click("(//li [@class ='select2-results-dept-1 select2-result select2-result-selectable select2-highlighted'])");
...
public void itemvat(String b) throws InterruptedException
{
	...
	type("//input [@class='select2-input select2-focused']",b);
	Thread.sleep(1000);
	click("(//li [@class = 'select2-results-dept-1 select2-result select2-result-selectable select2-highlighted'])[1]");
