...
public class Customer_US extends Wrapper_US {
	
	
	
	public Customer_US(WebDriver ldriver)
	{
		this.driver = ldriver;
	}
	...
	public HashMap<String,String> customername()
	{
		...
		customer.put("Azar", "Mohamed_Azarudeen_azarudeen@commusoft.com_9626565203_coimbatore");
		
		return customer;
		
	}
		String a = customername().get("Azar");
		String Azar[] = a.split("_");
	...
	{
		type("#customertype_contacts_name", Azar[0]);
	}
	public void Unique_Customer_Name()
	{
		String name = Azar[0] + new Random().nextInt(1000);
	...
	{
		type("#customertype_contacts_surname", Azar[1]);
	}
	public void Customer_Mobile()
	{
		type("#customertype_contacts_contactstelephone_0_telephonenumber", Azar[3]);
	}
	...
	{
		type("#customertype_addressline1", Azar[4]);
	}
	public void Customer_AddressLine2()
	{
		type("//*[@id=\"main\"]/div[2]/div/ng-container/div[2]/span[1]/div/div[1]/div/div/form/fieldset[2]/div[2]/div[2]/div[3]/div/input", Azar[5]);
	}
